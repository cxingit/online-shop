...
public class ApplicationConfig {
    ...
    public DataSource dataSource() {
        ...
        // 只需要修改红色部分, 保留其他内容
        dataSource.setUrl("jdbc:mysql://laiproject-instance.cimycpqfb2ht.us-east-2.rds.amazonaws.com:3306/ecommerce?createDatabaseIfNotExist=true&serverTimezone=UTC");
        dataSource.setUsername("admin");
        dataSource.setPassword("xinchen1996");
